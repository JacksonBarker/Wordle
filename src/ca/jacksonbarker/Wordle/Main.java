...
public class Main extends JFrame implements KeyListener {
    ...
    // Start timer, assigns word letter array, and calls the method which
    ...
    public static void enter() {
        ...
        if (isValidWord(cells[activeLine][0].getText() + cells[activeLine][1].getText() + cells[activeLine][2].getText()
                + cells[activeLine][3].getText() + cells[activeLine][4].getText())) {
            ...
            if ((cells[activeLine][0].getText() + cells[activeLine][1].getText() + cells[activeLine][2].getText()
                ...
                if (guesses != 1) {
                    JOptionPane.showMessageDialog(game,
                            String.format("You guessed the Wordle!\nYou took %d:%02d.\nYou made %d guesses.", minutes,
                                    seconds, guesses)); // Winbox for More Than 1 Guess
                } else {
                    JOptionPane.showMessageDialog(game,
                            String.format("You guessed the Wordle!\nYou took %d:%02d.\nYou made %d guess.", minutes,
                                    seconds, guesses)); // Winbox For Only 1 Guess
                }
                System.exit(0);
            }
            activeLine += 1;
    ...
    public static void updateKeyboard() {
        ...
        for (int i = 0; i < keys.length; i++) {
            for (int j = 0; j < cells[0].length; j++) {
                if (cells[prevLine][j].getBackground() == Color.lightGray
                        && cells[prevLine][j].getText().equals(keys[i].getText())
                        && keys[i].getBackground() != Color.yellow && keys[i].getBackground() != Color.green) {
                    keys[i].setBackground(Color.lightGray);
                }
                if (cells[prevLine][j].getBackground() == Color.yellow
                        && cells[prevLine][j].getText().equals(keys[i].getText())
                        && keys[i].getBackground() != Color.green) {
                    keys[i].setBackground(Color.yellow);
                }
                if (cells[prevLine][j].getBackground() == Color.green
                        && cells[prevLine][j].getText().equals(keys[i].getText())) {
